...
public enum Connector {
    ...
    Connector() {
        try {
            ...
            config.addDataSourceProperty("cachePrepStmts",
                    properties.getProperty("dataSource.cachePrepStmts"));
            config.addDataSourceProperty("prepStmtCacheSize",
                    properties.getProperty("dataSource.prepStmtCacheSize"));
            config.addDataSourceProperty("prepStmtCacheSqlLimit",
                    properties.getProperty("dataSource.prepStmtCacheSqlLimit"));
            config.setMaximumPoolSize(
                    Integer.parseInt(properties.getProperty("dataSource.maximumPoolSize")));
    ...
    public Connection getConnection() {
        try {
            ...
            throw new ConnectorException("Error : Database connection has not been correctly done.",
                    e);
        }
    }
}