...
<link href="resources/css/main.css" type="text/css" rel="stylesheet"
	media="screen">
<link href="resources/css/addComputer.css" type="text/css"
	rel="stylesheet" media="screen">
</head>
<body>
	<header class="navbar navbar-inverse navbar-fixed-top">
		<div class="container">
			<mytag:link value="Application - Computer Database"
				cssClass="navbar-brand" page="1" />
			<a class="navbar-right btn btn-default navbar-btn" href="logout"><spring:message
					code="logout" /> <i class="glyphicon glyphicon-log-out"></i></a>
			<div class="navbar-right panel-icon">
				<a href="?mylocale=en"> <img class="flag-icon"
					src="resources/images/UK.jpeg" />
				</a> <a href="?mylocale=fr"> <img class="flag-icon"
					src="resources/images/france.jpg" />
				</a>
			</div>
		</div>
	</header>
